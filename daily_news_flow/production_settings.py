# Production Settings for Daily News Flow
...
ROOT_URLCONF = 'daily_news_flow.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'news.context_processors.market_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'daily_news_flow.wsgi.application'
...
if config('EMAIL_HOST', default=None):
    ...
    DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@dailynewsflow.com')
    
    # Admin email for error notifications
    ADMINS = [
        ('Admin', config('ADMIN_EMAIL', default='admin@dailynewsflow.com')),
    ]
    MANAGERS = ADMINS
